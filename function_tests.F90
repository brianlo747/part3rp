program function_tests
  ...
  print *, dqh_dt__accretion_ice_graupel(0.05_kreal, 1.2_kreal, 0.01_kreal, &
  250.0_kreal)
  print *, dqh_dt__accretion_cloud_graupel_rain(0.05_kreal, 1.2_kreal, &
  1.20_kreal, 0.01_kreal)
  print *, dqr_dt__accretion_ice_rain_graupel_i(0.1_kreal, 1.2_kreal, &
  1.20_kreal, 0.1_kreal)
  print *, dqr_dt__accretion_ice_rain_graupel_r(0.05_kreal, 0.01_kreal, &
  1.20_kreal, 1.1_kreal, 0.05_kreal)
  ...
  print *, dqi_dt__freezing_graupel(0.1_kreal, 1.6_kreal, 260.0_kreal)
